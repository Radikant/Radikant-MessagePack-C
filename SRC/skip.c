...
mp_error_t mp_skip(mp_decoder_t* decoder) {
    ...
    switch (b) {
        ...
        case MP_TAG_FIXEXT1: return stream_skip(decoder, 2);
        case MP_TAG_FIXEXT2: return stream_skip(decoder, 3);
        case MP_TAG_FIXEXT4: return stream_skip(decoder, 5);
        case MP_TAG_FIXEXT8: return stream_skip(decoder, 9);
        case MP_TAG_FIXEXT16: return stream_skip(decoder, 17);
